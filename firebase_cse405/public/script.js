$(document ).ready(function() {
    ...
    $('#dynamicBtn').click(function(){
        ...
        if($(this).text() == "Save Changes"){
            ...
            db.collection("employees").doc(docuName).set({
                ...
                $('#operationStatus').html('<div class="alert-success"><strong>Success!</strong> Employee wascreated!</div>').delay(2500).fadeOut('slow');
            ...
            sfDocRef.set({
                ...
                .catch(function (error) {
                    $('#operationStatus').html('<div class="alert alert-danger"><strong>Failure!</strong>Employee could not be updated.</div>').elay(2500).faeOut('slow');
    ...
    $("tbody.tbodyData").on("click","td.deleteEmployee", function(){
        ...
        db.collection("employees").doc(docuName).delete().then(function(){
            $('#operationStatus').html('<div class="alert alert-danger"><strong>Success!</strong> Employee was deleted.</div>').delay(2500).fadeOut('slow');
            LoadData();
        }).catch(function(error){
